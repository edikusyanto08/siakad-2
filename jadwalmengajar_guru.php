...
<div id="tombolprint">
    <a style="text-decoration: none; position:absolute;" class="btn-btnprintcetakjadwal" target="blank" id="btnPrint" href="printjadwal.php">  
    <input type="submit" value="Cetak Jadwal" class="btn-btnjadwalgurucetak">
    </a>
</div>  
    <div id="printReady">
            ...
            <div class="hari">
                ...
                <?php
                    $datajadwal =" SELECT * FROM jadwalharian jh
                                    ...
                                    JOIN guru g ON g.nip=jh.nip WHERE jh.hari=1 and g.nip='$_SESSION[username]' ORDER BY g.nama ASC";
            ...
            <div class="hari">
                ...
                <?php
                    $datajadwal =" SELECT * FROM jadwalharian jh
                                    ...
                                    JOIN mapel m ON m.kd_mapel=jh.kd_mapel
                                    JOIN kelas k ON k.kd_kelas=jh.kd_kelas
                                    JOIN guru g ON g.nip=jh.nip WHERE jh.hari=2 and g.nip='$_SESSION[username]' ORDER BY g.nama ASC";
                    $hasil=mysqli_query($con,$datajadwal);
            ...
            <div class="hari">
                ...
                <?php
                    $datajadwal =" SELECT * FROM jadwalharian jh
                                    ...
                                    JOIN mapel m ON m.kd_mapel=jh.kd_mapel
                                    JOIN kelas k ON k.kd_kelas=jh.kd_kelas
                                    JOIN guru g ON g.nip=jh.nip WHERE jh.hari=3 and g.nip='$_SESSION[username]' ORDER BY g.nama ASC";
                    $hasil=mysqli_query($con,$datajadwal);
            ...
            <div class="hari">
                ...
                <?php
                    $datajadwal =" SELECT * FROM jadwalharian jh
                                    ...
                                    JOIN mapel m ON m.kd_mapel=jh.kd_mapel
                                    JOIN kelas k ON k.kd_kelas=jh.kd_kelas
                                    JOIN guru g ON g.nip=jh.nip WHERE jh.hari=4 and g.nip='$_SESSION[username]' ORDER BY g.nama ASC";
                    $hasil=mysqli_query($con,$datajadwal);
            ...
            <div class="hari">
                ...
                <?php
                    $datajadwal =" SELECT * FROM jadwalharian jh
                                    ...
                                    JOIN mapel m ON m.kd_mapel=jh.kd_mapel
                                    JOIN kelas k ON k.kd_kelas=jh.kd_kelas
                                    JOIN guru g ON g.nip=jh.nip WHERE jh.hari=5 and g.nip='$_SESSION[username]' ORDER BY g.nama ASC";
                    $hasil=mysqli_query($con,$datajadwal);
            ...
            <div class="hari">
                ...
                <?php
                    $datajadwal =" SELECT * FROM jadwalharian jh
                                    ...
                                    JOIN mapel m ON m.kd_mapel=jh.kd_mapel
                                    JOIN kelas k ON k.kd_kelas=jh.kd_kelas
                                    JOIN guru g ON g.nip=jh.nip WHERE jh.hari=6 and g.nip='$_SESSION[username]' ORDER BY g.nama ASC";
                    $hasil=mysqli_query($con,$datajadwal);
