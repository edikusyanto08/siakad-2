...
if(isset($_POST['simpan'])){
	...
	foreach ($_POST['nis'] as $nis) {
		...
		$tampildata = mysqli_query($con,"SELECT * FROM absensi WHERE tgl_absen='$_POST[tgl_absen]' and nis='$nis' and id_ta='$_POST[id_ta]' and kd_kelas='$_POST[kd_kelas]'");
		...
		$sql= "insert into absensi (id_ta, tgl_absen, kd_kelas, nis, keterangan) values('$_POST[id_ta]', '$_POST[tgl_absen]','$_POST[kd_kelas]', '$nis', '$keterangan[$a]')";
	...
	<form method="post" action="">
		<table width="1080" class="tb-frmkelas" border="0" align="center" cellpadding="2" cellspacing="0">
	     	<tr class="kelas-table">
				...
				<th width="100"><div align="center">Hari</div></th>
	        ...
	        <tr>
	                ...
	                <td>
	                	<select name="keterangan[]" id="keterangan" class="select-style">
	                		<option value='-'>-- Pilih --</option>
	                		<?php 
	                			foreach(array('Sakit','Izin','Alpha') as $ket) {
